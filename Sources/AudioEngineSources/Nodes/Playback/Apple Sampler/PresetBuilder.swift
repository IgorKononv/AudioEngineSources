...
public class PresetBuilder {
    ...
    static func generateMinimalConnections(layer: Int = 0) -> String {
        ...
        let pitchingDest: Int = 816_840_704 + layerOffset
        ...
        str.append(generateConnectionDict(id: 0,
                                          source: 300,
                                          destination: pitchingDest,
                                          scale: 12_800,
                                          transform: 1,
                                          invert: false)) // keynum->pitching
...
/*
 ...
 816840704 = layer1pitching
 816840960 = layer2pitching (+256)
 816841216 = layer3pitching (+256)
