...
/// - pitchingWheel:
///    common keyboard control that allow for a pitching to be bent up or down a given number of semitones
///
public enum MIDIStatusType: Int {
    ...
    /// A pitching wheel is a common keyboard control that allow for a pitching to be
    /// bent up or down a given number of semitones
    case pitchingWheel = 14
    ...
    public var length: Int {
        ...
        case .programChange, .channelAftertouch:
            return 2
        case .noteOff, .noteOn, .controllerChange, .pitchingWheel, .polyphonicAftertouch:
            return 3
        }
    }
