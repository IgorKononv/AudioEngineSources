...
open class MIDICallbackInstrument: MIDIInstrument {
    ...
    /// Receive pitching wheel value
    ///
    /// - Parameters:
    ///   - pitchingWheelValue: MIDI pitching Wheel Value (0-16383)
    ///   - channel:         MIDI Channel (1-16)
    ///   - portID:          MIDI Unique Port ID
    ///   - timeStamp:       MIDI Event TimeStamp
    ///
    open override func receivedMIDIpitchingWheel(_ pitchingWheelValue: MIDIWord,
                                              channel: MIDIChannel,
                                              portID: MIDIUniqueID? = nil,
                                              timeStamp: MIDITimeStamp? = nil) {
        triggerCallbacks(MIDIStatus(type: .pitchingWheel, channel: channel),
                         data1: pitchingWheelValue.msb,
                         data2: pitchingWheelValue.lsb)
    }
